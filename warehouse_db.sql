...
CREATE TABLE `goods` (
  ...
  `lrack` varchar(128) not null default '{"lrack1":"01","lrack2":"A","lrack3":"01"}' comment '大货架',
  `mrack` varchar(128) not null default '{"mrack1":"01","mrack2":"A","mrack3":"01"}' comment '小货架',
