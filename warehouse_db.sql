...
`customer_company` VARCHAR(255) NOT NULL default '' comment '客服公司',
...
`inv_head` VARCHAR(640) NOT NULL default '' comment '发票抬头',
...
create table `ledger_receivable`(
  ...
  `pay_company` varchar(255) not null default '' comment '付款公司',
  `amount` double(20,4) not null default 0.0 comment '金额',
...
`rate_tax` DOUBLE(4,2) NOT NULL default 0.0 comment '税率',
`inv_date` DATE NOT NULL default '1900-01-01' comment '开票日期',
`inv_type` smallint(2) not null default 0 comment '0-公司、1-个人',
